if(zxnz && zxnz.sql){
    ...
    zxnz.sql.extendMethod('rights', function (user_uuid, merchant_uuid){
        return ZXNZ_SQL.rights.format(user_uuid, merchant_uuid);
    });

    zxnz.sql.extendMethod('observeRights', function (user_uuid, merchant_uuid){
        return ZXNZ_SQL.observe_rights.format(user_uuid, merchant_uuid);
    });

    zxnz.sql.extendMethod('inRights', function (user_uuid, field){
